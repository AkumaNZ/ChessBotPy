	...
	<div id="app" class="font-sans text-gray-100">
		<div id="layout">
			...
			<div id="board" class="bg-gray-800 p-3" >
				<span class='font-display text-gray-200 fixed text-shadow'>{{currentEco}}</span>
